...
$(function(){
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-header img").attr("src", "assets/images/logo.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo.png");
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-2.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-2.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-2.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-2.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-2.png");
        return false;
    });

    jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-3.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-3.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-3.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-3.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-3.png");
        return false;
    });

    jQuery(".skin-4").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-4.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-4.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-4.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-4.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-4.png");
        return false;
    });

    jQuery(".skin-5").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-5.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-5.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-5.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-5.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-5.png");
        return false;
    });

    jQuery(".skin-6").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-6.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-6.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-6.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-6.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-6.png");
        return false;
    });

    jQuery(".skin-7").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-7.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-7.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-7.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-7.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-7.png");
        return false;
    });

    jQuery(".skin-8").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-8.css");
		jQuery(".logo-header img").attr("src", "assets/images/logo-8.png");
		jQuery(".header-transparent .logo-header img").attr("src", "assets/images/logo-white-8.png");
		jQuery(".logo-header.logo-white img").attr("src", "assets/images/logo-white-8.png");
		jQuery(".box-header .logo-header img").attr("src", "assets/images/logo-8.png");
        return false;
    });
	//=== Color css change function	=====================//

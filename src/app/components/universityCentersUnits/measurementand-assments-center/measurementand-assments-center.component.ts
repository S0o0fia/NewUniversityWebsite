...
@Component({
  selector: 'app-measurementand-assments-center',
  templateUrl: './measurementand-assments-center.component.html',
  styleUrls: ['./measurementand-assments-center.component.css']
})
export class MeasurementandAssmentsCenterComponent implements OnInit {
  skills : any = {

...
@Component({
  selector: 'app-gradutes-affairs',
  templateUrl: './gradutes-affairs.component.html',
  styleUrls: ['./gradutes-affairs.component.css']
})
export class GradutesAffairsComponent implements OnInit {
  skills : any = {

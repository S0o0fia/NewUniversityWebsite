...
import { GoalsElmentComponent } from './uni-element/goals-elment/goals-elment.component';
import { MessageVisionUniversityComponent } from './uni-element/message-vision-university/message-vision-university.component';
...
import { HistoryElementComponent } from './uni-element/history-element/history-element.component';
import { VideoElementComponent } from './uni-element/video-element/video-element.component';
...
import { GraduteSliderComponent } from './elements/rev-slider/gradute-slider/gradute-slider.component';
import { Graduationcontent1Component } from './elements/content-box/graduationcontent1/graduationcontent1.component';
import { GraduationcounterComponent } from './elements/counter/graduationcounter/graduationcounter.component';
import { Gradutesevent1Component } from './elements/events/gradutesevent1/gradutesevent1.component';
...
import { GraduteAffairsHeaderComponent } from './elements/header/gradute-affairs-header/gradute-affairs-header.component';
...
import { StudentSliderComponent } from './elements/rev-slider/student-slider/student-slider.component';
import { StudentsAffairsHeaderComponent } from './elements/header/students-affairs-header/students-affairs-header.component';
import { StudentsAffairContentComponent } from './elements/content-box/students-affair-content/students-affair-content.component';
import { StudentAffairsEventsComponent } from './elements/events/student-affairs-events/student-affairs-events.component';
...
import { StudentAffairsCounterComponent } from './elements/counter/student-affairs-counter/student-affairs-counter.component';
...
import { ConfrenceHeaderComponent } from './elements/header/confrence-header/confrence-header/confrence-header.component';
import { ConfrenceSliderComponent } from './elements/rev-slider/confrence-slider/confrence-slider/confrence-slider.component';
...
@NgModule({
  declarations: [
    ...
    GoalsElmentComponent,
    MessageVisionUniversityComponent,
    UniversityVisionMessageComponent,
    UniversityHistoryComponent,
    HistoryElementComponent,
    VideoElementComponent,
    StudentsAffairsComponent,
    GradutesAffairsComponent,
    GraduteSliderComponent,
    Graduationcontent1Component,
    GraduationcounterComponent,
    Gradutesevent1Component,
    GraduationStudyNewDetailsComponent,
    GraduationStudyNewsComponent,
    GraduteAffairsHeaderComponent,
    GraduteAffiarIntroComponent,
    GraduteStudyManagerWordComponent,
    AboutDiplomaComponent,
    AboutMasterComponent,
    AboutPhdComponent,
    FLDPComponent,
    CalenderCenterComponent,
    InternationalCooperationExternalRelationsComponent,
    GuesthouseComponent,
    StudentSliderComponent,
    StudentsAffairsHeaderComponent,
    StudentsAffairContentComponent,
    StudentAffairsEventsComponent,
    StudentsAffairNewDetailsComponent,
    StudentsAffairNewsComponent,
    StudentAffairInfoComponent,
    StudentAffairManagerWordComponent,
    StudentsAffairMessageComponent,
    StudentsAffairGoalsComponent,
    StudentAffairTasksComponent,
    StudentAffairsCounterComponent,
    StudentsResultComponent,
    ArchologyCodesComponent,
    FineartCodesComponent,
    ToursimCodesComponent,
    AlsunCodesComponent,
    ConferenceComponent,
    ConfrenceHeaderComponent,
    ConfrenceSliderComponent,
    ConfrenceCounterComponent,
